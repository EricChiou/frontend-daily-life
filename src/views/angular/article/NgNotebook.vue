    ...
    <div class="article">
      ...
      <div class="content">
        ...
        <div class="text">
          ...
          <div class="code-area">ng g c path/component-name --module</div>
          <br>新增 Service：
          <div class="code-area">ng g s path/service-name</div>
          <br>新增 Module 以及該 Module 的 Router：
          <div class="code-area">ng g m module-name --routing</div>
          <br>
        </div>
        ...
        <div class="text">
          ...
          <div class="code-area">[routerLink]="path" routerLinkActive="active"</div>
